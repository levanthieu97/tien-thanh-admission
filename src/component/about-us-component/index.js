              ...
              <li className="banner__list-item">
                ...
                <div className="item">
                  ...
                  <a
                    ...
                    href="https://www.facebook.com/H%E1%BB%8Dc-L%C3%A1i-Xe-TI%E1%BA%BEN-TH%C3%80NH-TP-HCM-113932790454769"
                  >
                    Học Lái Xe TIẾN THÀNH
                  </a>
                </div>
              </li>
              <li className="banner__list-item">
                ...
                <div className="item">
                  <span>Email:</span> hotrotienthanh@gmail.com
                </div>
              </li>
              <li className="banner__list-item">
                <FontAwesomeIcon icon={faPhone} pull="left" />
                <div className="item item-phone">
                  <span>Phone:</span> 0862 376 568
                </div>
              </li>
              <li className="banner__list-item">
                <FontAwesomeIcon icon={faPhone} pull="left" />
                <div className="item item-phone">
                  <span>Phone:</span> 0977 346 168
                </div>
              </li>
              <li className="banner__list-item">
                <FontAwesomeIcon icon={faLocationDot} pull="left" />
                <div className="item">
                  <span>Địa chỉ:</span> 40 Lê Thiệt, P. Phú Thọ Hòa, Q. Tân Phú, TP.HCM
                </div>
              </li>
            </ul>
          </div>
